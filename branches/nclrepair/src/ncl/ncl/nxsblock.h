...
class NxsBlock
	...
	public:
		enum NxsBlockLinkStatus
			...
			BLOCK_LINK_UNUSED_MASK =      0x1F,
			BLOCK_LINK_USED =             0x20
			};
		...
		*/
		...
		void 				ReadPartitionDef(NxsPartition &np, NxsLabelToIndicesMapper &ltm, const std::string & partName, const char * ptype, const char * cmd, NxsToken & token, bool warnAsterisked, bool demandAllInds = false);
